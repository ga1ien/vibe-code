    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto text-center -mt-[64px] sm:mt-0 lg:-mt-[200px]">
        ...
        >
          ...
          <span className="sm:hidden bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent flex flex-col">
            <span className="block">Build Anything</span>
            <span className="text-3xl block mt-2">by Just Describing It</span>
          </span>
